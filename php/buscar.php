...
<form action="buscarhp.php" method="POST" class="text-dark" >
  <div class="container col-md-6" >
    <!--titulo Formulario-->
    <h2 class="display-5 p-5 text-center">Que Documento Buscas</h2>
  <div class="form-row">
    ...
    <!--Numero Documento-->
    <div class="form-group col-md-12">
      <label for="ndocumento">Digite El Numero</label><br>
      <input type="number" class="form-control" id="ndocumento" name="cc">

    </div>
    <!--Fecha De Nacimiento-->
    <div class="form-group col-md-12">
      <label for="fnacimiento">Fecha De Nacimiento</label>
      <input type="date" class="form-control" id="fnacimiento" name="fn">
    </div>
    <!--Fecha De Expedicion-->
    <div class="form-group col-md-12">
      <label for="fexpedicion">Fecha De Expedicion</label>
      <input type="date" class="form-control" id="fexpedicion" name="fe">
    </div>
